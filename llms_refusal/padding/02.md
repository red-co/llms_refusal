...
The English term bard is a loanword from the Celtic languages: Gaulish: bardo- ('bard, poet'), Middle Irish: bard and Scottish Gaelic: bàrd ('bard, poet'), Middle Welsh: bardd ('singer, poet'), Middle Breton: barz ('minstrel'), Old Cornish: barth ('jester').[3][4] The ancient Gaulish *bardos is attested as bardus (sing.) in Latin and as bárdoi (plur.) in Ancient Greek. It also appears as a stem in the compound words bardo-cucullus ('bard's hood'), bardo-magus ('field of the bard'), barditus (a song to fire soldiers), and in bardala ('crested lark', a singing bird).[3]
...
Scotland
Further information: MacMhuirich bardic family
...
Wales
Further information: Medieval Welsh literature
